  ...
  return (
    <div className="w-full px-4 py-8">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="text-gray-800 mb-4 text-center text-sm text-gray-600 my-4">
        ...
        <div className="shadow-md rounded-md p-4 bg-white mt-10">
          <form>
            <textarea
              className="border border-gray-200 rounded-md py-2 px-4 w-full"
              autoFocus
              autoComplete="off"
            ...
            <div className="w-full flex">
              <button
                className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-3 rounded ml-auto text-xs"
                disabled={!message}
                onClick={addPost}
              >
                POST
